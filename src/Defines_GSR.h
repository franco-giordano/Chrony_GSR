...
#define GSR_MENU_WIFI 28
#define GSR_MENU_OTAU 29
#define GSR_MENU_OTAM 30
#define GSR_MENU_SCRN 31
#define GSR_MENU_RSET 32
#define GSR_MENU_TOFF 33  // Time Diff offset.
#define GSR_MENU_UNVS 34
